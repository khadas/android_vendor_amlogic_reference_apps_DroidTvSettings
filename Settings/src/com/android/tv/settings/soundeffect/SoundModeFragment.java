...
public class SoundModeFragment extends LeanbackPreferenceFragment implements Preference.OnPreferenceChangeListener, SeekBar.OnSeekBarChangeListener {
    ...
    private void init() {
        ...
        mAudioEffectManager = ((DroidLogicTvSettingsActivity)getActivity()).getAudioEffectManager();
        mTvControlManager = TvControlManager.getInstance();
        mSoundParameterSettingManager = ((DroidLogicTvSettingsActivity)getActivity()).getSoundParameterSettingManager();
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        ((DroidLogicTvSettingsActivity)getActivity()).startShowActivityTimer();
