...
public abstract class DroidTvSettingsActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {

    private static final String TAG = "DroidTvSettingsActivity";
    ...
    public void startShowActivityTimer () {
        ...
        int seconds = DataProviderManager.getIntValue(this, TvOptionSettingManager.KEY_MENU_TIME,
                TvOptionSettingManager.DEFUALT_MENU_TIME);
        if (seconds == 1) {
            seconds = 15;
        } else if (seconds == 2) {
            seconds = 30;
    ...
    public void finish() {
        ...
        try {
            ...
            isresumed = (boolean)isResumedMethod.invoke(DroidTvSettingsActivity.this);
        }catch (Exception ex){
        }
           ...
           /* slide.setSlideFraction(
            ...
            slide.addListener(new Transition.TransitionListener() {
                ...
                public void onTransitionEnd(Transition transition) {
                    ...
                    DroidTvSettingsActivity.super.finish();
                }
