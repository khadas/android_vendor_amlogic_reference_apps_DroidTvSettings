...
public class PowerKeyActionDefinitionFragment extends LeanbackPreferenceFragment {
    ...
    private static final String FORCE_SUSPEND_RESET_PROP = "-1";
    private static final String FORCE_SUSPEND_DEFAULT_TIMEOUT = "5000";
    private static final String FORCE_SUSPEND_PROPERTY = "persist.sys.str.forcesuspend";
    ...
    private void setPowerKeyActionDefinition(int keyValue) {
        if (keyValue == FORCE_SUSPEND) {
            SystemProperties.set(FORCE_SUSPEND_PROPERTY, FORCE_SUSPEND_DEFAULT_TIMEOUT);
        } else {
            SystemProperties.set(FORCE_SUSPEND_PROPERTY, FORCE_SUSPEND_RESET_PROP);
        }
