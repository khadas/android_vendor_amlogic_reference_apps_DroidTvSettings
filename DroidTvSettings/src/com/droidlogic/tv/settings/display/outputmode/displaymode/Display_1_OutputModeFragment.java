...
public class Display_1_OutputModeFragment extends SettingsPreferenceFragment {
    private static final String TAG = "Display_1_OutputModeFragment";
    ...
    public static Display_1_OutputModeFragment newInstance() {
        return new Display_1_OutputModeFragment();
    }
    ...
    private List<Action> getMainActions() {
        ...
        List<String> outputModeValueList = mDisplayCapabilityManager.getDisplayModeListById(1);
        String currentMode = mDisplayCapabilityManager.getCurrentModeById(1);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        if (preference instanceof RadioPreference) {
            ...
            if (radioPreference.isChecked()) {
                String sysCurrentMode = mDisplayCapabilityManager.getCurrentModeById(1);
                ...
                mDisplayCapabilityManager.setResolutionById(UserPreferredDisplayMode, 1);
                mRestoreCallback =
                        () -> {
                            mDisplayCapabilityManager.setResolutionById(sysCurrentMode, 1);
                        };
    ...
    private void updatePreferenceFragment() {
        Log.d(TAG, "update display 1 mode");
